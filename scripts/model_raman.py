...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Script for training ordinal regression models on preprocessed Raman spectra (LOOCV)",
    ...
    for ix, (train_index, test_index) in enumerate(LeaveOneGroupOut().split(X, y, groups_CV)):
        ...
        model, _, _ = Tune(OrdinalModel, param_grid, X_train, y_train, groups_train, splitter = UnitarySplitter(5))
